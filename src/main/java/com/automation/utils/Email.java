    ...
    public static void sendEmail() {
        ...
        Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication("sidharth.shukla19@gmail.com", "Shirdi@579");
                    }
                });
        try {
            ...
            String filename = System.getProperty("user.dir") + "/htmlReports/" + BaseTest.TimeStamp + "/" + "API_Automation.html";
